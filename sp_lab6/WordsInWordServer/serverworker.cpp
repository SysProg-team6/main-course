...
void ServerWorker::sendJson(const QJsonObject &json)
{
    ...
    emit logMessage("Sending to " + QString::fromStdString(_p->getName()) + " - " + QString::fromUtf8(jsonData));
...
Player* ServerWorker::getPlayer() const
{
    return _p;
}

void ServerWorker::setPlayer(Player *p)
{
    _p = p;
}
