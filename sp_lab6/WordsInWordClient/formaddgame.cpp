...
FormAddGame::FormAddGame(Player &player, Client *client, QWidget *parent) : QWidget(parent)
{
    _player = player;
    _client = client;
    string combinations;
...
FormAddGame::FormAddGame(Player &player, QWidget *parent) : QWidget(parent)
{
    _player = player;
    string combinations;
